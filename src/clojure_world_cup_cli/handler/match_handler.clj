    ...
    (do 
        ...
        (print-table ["Date" "Result" "Stadium"]
            ...
            (for [match matches] 
                ...
                "Result" (if-let [home-team (team-handler/get-first-team-by-id teams (get match :home_team))]
                                (if-let [away-team (team-handler/get-first-team-by-id teams (get match :away_team))]
                                    (format 
                                    "%-8s %s:%s %-8s"
                                    (get home-team :name)
