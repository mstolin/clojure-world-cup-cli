...
(def groups {
  :a {
    ...
    :matches [
      ...
      {:date "2018-06-19T21:00:00+03:00" :channels [3 6 13 17 15 21 22] :name 17 :away_result 1 :matchday 2 :stadium 1 :type "group" :finished true :home_team 1 :away_team 3 :home_result 3} 
...
(deftest get-number-of-matches-for-stadium
  (testing "Get the number of matches for the given stadium"
    (is (=
      (count 
        (match-handler/get-matches-for-stadium (get (get groups :a) :matches) 1))
      2))))
